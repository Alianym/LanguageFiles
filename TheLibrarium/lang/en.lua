...
local stringsEN = {
	SI_BINDING_NAME_LIBRARIUM_OPEN_COMPENDIUM_KEY = "Open the Librarium",
	--
	...
	LIBRARIUM_MENU_JOURNAL = string.format("|t52:52:%s|t%s", "EsoUI/Art/Progression/progression_indexIcon_world_down.dds", "The Librarium:"),
	LIBRARIUM_WINDOW_TITLE_LORE_LIBRARY = string.format("|t52:52:%s|t%s", "EsoUI/Art/Progression/progression_indexIcon_world_down.dds", "The Librarium:"),
	--
	LIBRARIUM_ADVENTURES_CLOSE_BOOK = "<CLOSE>",
	...
	LIBRARIUM_EDITOR_SEND_CUSTOM_BOOK = "Send Mail",
	LIBRARIUM_EDITOR_SEND_MAIL_NAME = "Send Mail?",
	LIBRARIUM_EDITOR_MAIL_SUBJECT_PREFIX = "LIBR",
	--
	LIBRARIUM_MAIL_ATTACHED = "Attached",
